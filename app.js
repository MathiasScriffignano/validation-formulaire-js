...
inpUtilisateur.addEventListener('input', (e) => {
    ...
    if(e.target.value.length >= 3){
        ...
        allImg[0].src = 'check.svg';
        allSpan[0].style.display = 'none';
    }else{
        allImg[0].style.display = 'inline';
        allImg[0].src = 'error.svg';
...
inpMail.addEventListener('input', (e) => {
    ...
    if(e.target.value.search(regexEmail) === 0){
        ...
        allImg[1].src = 'check.svg';
        allSpan[1].style.display = 'none';
    }else if(e.target.value.search(regexEmail) === -1){
        allImg[1].style.display = 'inline';
        allImg[1].src = 'error.svg';
...
let testAll = 0;
    ...
    if(testAll < 3){
        ...
        allImg[2].src = "error.svg";
    } else {
        allSpan[2].style.display = "none";
        allImg[2].src = "check.svg";
    }
...
inpConfirm.addEventListener('input', (e) =>{
    if(e.target.value.length === 0){
        ...
        allImg[3].src = "error.svg";
    }
    else if (e.target.value === valeurInp){
        allImg[3].style.display = "inline";
        allImg[3].src = "check.svg";
    }else{
        allImg[3].style.display = "inline";
        allImg[3].src = "error.svg";
    }
